/*
  ...
  - You are about to drop the column `relavanceExplanation` on the `Paper` table. All the data in the column will be lost.
  - You are about to drop the column `relavanceScore` on the `Paper` table. All the data in the column will be lost.
